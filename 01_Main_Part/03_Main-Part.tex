...
\centering
  \begin{subfigure}[c]{0.49\textwidth}
	...
	\end{tikzpicture}
    \caption{Diagramm einer Schleifen-Kante (Variante 1) (\texttt{<rule> = \{NodeEdge\};})}
...
\centering
  ...
  \end{subfigure}
  \caption{Diagramm und Interface einer Schleifen-Kante (Variante 3) (\texttt{<rule> = \{NodeEdge\};})}
