...
\centering
  \begin{subfigure}[c]{0.49\textwidth}
	...
	\end{tikzpicture}
    \caption{Diagramm eines Schleifen-Knotens (Variante 1)}
    \label{FIG:DiagramLoopNode}
  \end{subfigure}
  \begin{subfigure}[c]{0.49\textwidth}
    \lstinputlisting[language=Java,caption={Java-Interface aus einem Schleifen-Knoten (Variante 1)},label={LST:JInterfaceLoopNode}]{Scope_loop.java}
  \end{subfigure}
  \caption{Diagramm und Interface eines Schleifen-Knotens (Variante 1)}
  \label{FIG:LoopNode}
\end{figure}
...
\centering
  \begin{subfigure}[c]{0.49\textwidth}
	...
	\end{tikzpicture}
    \caption{Diagramm eines Schleifen-Knotens (Variante 2)}
    \label{FIG:DiagramLoopNodeAlternative}
  \end{subfigure}
  \begin{subfigure}[c]{0.49\textwidth}
    \lstinputlisting[language=Java,caption={Java-Interface aus einem Schleifen-Knoten (Variante 2)},label={LST:JInterfaceLoopNodeAlternative}]{Scope_loop_alt.java}
  \end{subfigure}
  \caption{Diagramm und Interface eines Schleifen-Knotens (Variante 2)}
...
\subsubsection{Schachtelung der Konstrukte}
