...
\centering
  \begin{subfigure}[c]{0.49\textwidth}
    \includegraphics[width=.95\linewidth]{\main/10_Pictures/Nodes_alternative_different-nodes}
...
\centering
  \begin{subfigure}[c]{0.49\textwidth}
    \includegraphics[width=.95\linewidth]{\main/10_Pictures/Nodes_loop_single_node}
