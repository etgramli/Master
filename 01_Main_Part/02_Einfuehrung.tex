...
Um die konkrete Syntax einer neuen DSL zu definieren, wird eine EBNF-Syntax verwendet, die sich an der ISO-Norm orientiert aber sich leicht davon unterscheidet. Zum Beispiel werden keine Kommentare und keine Ausnahme unterstützt. Listing~\ref{LST:EBNFSyntaxExample} zeigt die Syntax der wichtigsten EBNF-Konstrukte.

\begin{figure}[ht]
\lstinputlisting[linerange={3-49},caption={EBNF-Grammatik (Auszug)},label={LST:EBNFGrammar}]{Bnf.g4}
\end{figure}
